...
The user is able to add a fruit to the list, reads/fetches data when displaying it on the list, and the data persists even when they quit the app because the data is being saved to Core Data.
